...
import com.jth.kakao.pay.test.viewmodel.RepositoryListViewModel

class RepositoryListActivity : BaseBindingActivity<ActivityUserListBinding>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.viewModel = RepositoryListViewModel(CommonUseCase(this))
    }
}